...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGVtYW50bWg2NyIsImEiOiJjazd4Y3I4N3MwYnRpM29wOTVtZmtscXhyIn0.6aaNfJ4keyklI3gUhdWpOA';
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_eauRQcGm99ZtAkhCOExKufWo00opuPU0KV');
            _context.prev = 1;
            _context.next = 4;
